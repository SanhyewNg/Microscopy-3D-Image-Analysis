...
def main(parameters):
    ...
    Args:
        parameters (str): Path to a json file with following parameters:
                          ...
                          channel (list): which channel of the INPUT_FILE is Epith
...
def tweak_params(parameters):
    ...
    parameters["channel_name"] = "Epith"
    parameters["channel_color"] = "green"
    parameters["discrete"] = "binary"
    parameters["uff_colors"] = ("gray", "lime")
    parameters["model"] = "models/classification/model_7_eager_torvalds_3_class_epith.pkl"
    return parameters
