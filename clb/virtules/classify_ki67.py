...
def main(parameters):
    ...
    Args:
        parameters (str): Path to a json file with following parameters:
                          ...
                          channel (list): which channel of the INPUT_FILE is Ki67
...
def tweak_params(parameters):
    ...
    parameters["channel_name"] = "Ki67"
    parameters["channel_color"] = "yellow"
    parameters["discrete"] = "binary"
    parameters["uff_colors"] = ("gray", "yellow")
    parameters["model"] = "models/classification/model_7_eager_torvalds_3_class_Ki67.pkl"
    return parameters
