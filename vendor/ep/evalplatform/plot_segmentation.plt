...
set xlabel grid_xlabel noenhanced

set title plot_title font ",32" noenhanced

#===== PLOT DATA =====#
plot data_file index 1 using 2:xtic(1) title " Precision" with points pointtype 7 pointsize 2 \
	 ,data_file index 2 using 2:xtic(1) title "Recall" with points pointtype 7 pointsize 2 \
	 ,data_file index 3 using 2:xtic(1) title " F" with points pointtype 7 pointsize 2
